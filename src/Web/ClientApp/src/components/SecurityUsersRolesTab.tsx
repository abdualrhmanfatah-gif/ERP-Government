...
import { useUserDetail, useSetUserRole, useUserPermissions, useAssignUserPermission } from '@/features/security/users/hooks';
import { rolesClient } from '@/features/security/rbac/client';
