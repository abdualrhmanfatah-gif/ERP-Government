...
import { useUserPermissions, useAssignUserPermission, useRemoveUserPermission } from '@/features/security/users/hooks';
import { permissionsClient } from '@/features/security/rbac/client';
import { useQuery } from '@tanstack/react-query';
import type { EffectivePermissionDto } from '@/features/security/users/types';
