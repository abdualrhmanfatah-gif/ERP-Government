        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClosingMoveId = table.Column<int>(type: "int", nullable: true),
                    IsActive = table.Column<bool>(type: "bit", nullable: false, defaultValue: true),
                    RowVersion = table.Column<byte[]>(type: "rowversion", rowVersion: true, nullable: false),
                    Created = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AmountNet = table.Column<decimal>(type: "decimal(23,2)", nullable: false),
                    BaseAmountNet = table.Column<decimal>(type: "decimal(23,2)", nullable: false),
                    TotalDeductionAmount = table.Column<decimal>(type: "decimal(23,2)", nullable: true),
                    TotalNetAmount = table.Column<decimal>(type: "decimal(23,2)", nullable: true),
                    TotalPaidAmount = table.Column<decimal>(type: "decimal(23,2)", nullable: true),
                    TotalRemainingAmount = table.Column<decimal>(type: "decimal(23,2)", nullable: true),
                    IsFullyPaid = table.Column<bool>(type: "bit", nullable: false),
                    PaymentMethod = table.Column<int>(type: "int", nullable: false, defaultValue: 5),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MoveLineId = table.Column<long>(type: "bigint", nullable: true),
                    RowVersion = table.Column<byte[]>(type: "rowversion", rowVersion: true, nullable: false),
                    Created = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    LastModified = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BaseAmount = table.Column<decimal>(type: "decimal(23,2)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NetAmount = table.Column<decimal>(type: "decimal(23,2)", nullable: true),
                    CurrencyId = table.Column<int>(type: "int", nullable: true),
                    ExchangeRate = table.Column<decimal>(type: "decimal(18,6)", nullable: true),
                    BaseAmount = table.Column<decimal>(type: "decimal(23,2)", nullable: true),
                    AllocationStatus = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    AllocatedAmount = table.Column<decimal>(type: "decimal(23,2)", nullable: true),
                    RemainingAmount = table.Column<decimal>(type: "decimal(23,2)", nullable: true),
                    FundId = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    FundNumber = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    FundName = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    FundType = table.Column<int>(type: "int", maxLength: 20, nullable: false),
                    FundCategory = table.Column<int>(type: "int", maxLength: 20, nullable: false),
                    FiscalYearId = table.Column<int>(type: "int", nullable: true),
                    LegalAuthority = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.DefaultRevenueDebitAccountId,
                        principalTable: "Accounts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.BudgetClassificationId,
                        principalTable: "BudgetClassifications",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<int>(type: "int", nullable: false),
                    GeneratedMoveId = table.Column<int>(type: "int", nullable: true),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    RowVersion = table.Column<byte[]>(type: "rowversion", rowVersion: true, nullable: false),
                    Created = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
