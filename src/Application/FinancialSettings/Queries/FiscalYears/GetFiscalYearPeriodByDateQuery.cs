...
public class GetFiscalYearPeriodByDateQuery : IRequest<GetFiscalYearPeriodByDateResult?>
{
...
public class GetFiscalYearPeriodByDateQueryHandler(
    ...
    : IRequestHandler<GetFiscalYearPeriodByDateQuery, GetFiscalYearPeriodByDateResult?>
{
    public async Task<GetFiscalYearPeriodByDateResult?> Handle(
        ...
        CancellationToken cancellationToken)
    {
        ...
        if (fiscalYear is null) return null;
        ...
        return new GetFiscalYearPeriodByDateResult
        {
